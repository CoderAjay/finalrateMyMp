...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        btnSignup.Attributes.Add("OnClick", "javascript: return signupValueCheck()");// registering the javascript function for onclick event of linkbutton
        btnSingin.Attributes.Add("OnClick", "javascript: return signinValueCheck()");
        PasswordUpdate.Attributes.Add("OnClick", "javascript: return validateUpdatePassword()");
